...
<section id="sidebar"> 
  ...
  <div id="sidebar-nav"> 
    ...
    <?php if(Illuminate\Support\Facades\Auth::user()->role_id_fk == 2): ?>
      ...
      <li><a href="<?php echo e(route('home')); ?>"><i class="fa fa-sign-out"></i> Logout</a></li>
    <?php elseif(Illuminate\Support\Facades\Auth::user()->role_id_fk == 3): ?>
...
<script src="<?php echo e(asset('js/jquery-3.2.1.min.js')); ?>"></script>
	...
	<!-- smodel script -->
<script>
var username = "<?php echo e(\Illuminate\Support\Facades\Auth::id()); ?>";
    function clickX()
        {
          sendMessage();
        }
...
$.ajaxSetup({
    ...
    $.ajax({
        ...
        data: {id1:username,id2:<?php echo e($id); ?>,message:msg,},
...
function retrieveUnSeenChatMessages()
        {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo e(route('readunseenmessage')); ?>",
                data: {id1:username,id2:<?php echo e($id); ?>},
                success: function (data) {
 ...
 function retrieveChatMessages(numberofmessages)
        {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo e(route('readusermessage')); ?>",
                data: {id1:username,id2:<?php echo e($id); ?>,numberofmessages:numberofmessages},
                success: function (data) {
