...
<section id="sidebar"> 
  ...
  <div id="sidebar-nav"> 
    ...
    <ul>
      ...
      <li class="active"><a href="<?php echo e(route('tenet_info')); ?>"><i class="fa fa-info"></i> Tenant Info</a></li>
...
<table class="table table-dark">
  ...
  <?php
    $counter = 0;
  ?>
  <?php $__currentLoopData = App\User::all()->where('role_id_fk','=',2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $advisor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <tr>
      <th scope="row"><?php echo e(++$counter); ?></th>
      <td><?php echo e($advisor->email); ?></td>
      <td><?php echo e($advisor->tenetrelation->first_name); ?></td>
      <td><?php echo e($advisor->tenetrelation->last_name); ?></td>
      <td><?php echo e($advisor->tenetrelation->phone); ?></td>  
      <td>
        <form action="<?php echo e(route('admin_tenet_handler.destroy',[$advisor->id])); ?>" method="post">
        <?php echo csrf_field(); ?>
