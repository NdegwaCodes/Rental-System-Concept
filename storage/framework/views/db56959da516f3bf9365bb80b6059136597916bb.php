...
<section id="sidebar"> 
  ...
  <div id="sidebar-nav"> 
    ...
    <ul>
      ...
      <li ><a href="<?php echo e(route('advisor_info')); ?>"><i class="fa fa-info"></i> Advisor Info</a></li>
      <li ><a href="<?php echo e(route('advisor_upgrade')); ?>"><i class="fa fa-thumbs-up"></i> Advisor Upgradation</a></li>
      <li class="active"><a href="<?php echo e(route('admin_profile')); ?>"><i class="fa fa-user"></i> Profile</a></li>
...
<div class="content">
  <div id="sortable">
        <h5>First Name: </h5><span><?php echo e(Illuminate\Support\Facades\Auth::user()->adminrelation->first_name); ?></span>
        <h5>Last Name: </h5><span><?php echo e(Illuminate\Support\Facades\Auth::user()->adminrelation->last_name); ?></span>
        <h5>Phone:  </h5><span><?php echo e(Illuminate\Support\Facades\Auth::user()->adminrelation->phone); ?></span>
        <h5>Address: </h5><span><?php echo e(Illuminate\Support\Facades\Auth::user()->adminrelation->address); ?></span>
          <!--Grid row-->
    ...
    <div class="modal-content card card-image" style="background-image: url('img/modelimg.jpg');">
      <div class="text-white rgba-stylish-strong py-5 px-5 z-depth-4">
        ...
        <div class="modal-body">
          <!--Body-->
		  <form action="<?php echo e(route('update_admin_profile.update',[Illuminate\Support\Facades\Auth::id()])); ?>" method="post" autocomplete="">
		 <?php echo csrf_field(); ?>
     <?php echo method_field('put'); ?>
          <div class="md-form mb-5">
            <input type="text" name="fname" value="<?php echo e(Illuminate\Support\Facades\Auth::user()->adminrelation->first_name); ?>" id="Form-email5" class="form-control validate white-text">
            <label data-error="wrong" data-success="right" for="Form-email5">First Name</label>
          </div>
          <div class="md-form pb-3">
            <input type="text" name="lname" value="<?php echo e(Illuminate\Support\Facades\Auth::user()->adminrelation->last_name); ?>" id="Form-pass5" class="form-control validate white-text">
            <label data-error="wrong" data-success="right" for="Form-pass5">Last Name</label>
          </div>
          <div class="md-form pb-3">
            <input type="text" name="phone" value="<?php echo e(Illuminate\Support\Facades\Auth::user()->adminrelation->phone); ?>" id="Form-pass5" class="form-control validate white-text">
            <label data-error="wrong" data-success="right" for="Form-pass5">Phone Number</label>
          </div>
          <div class="md-form pb-3">
            <input type="text" name="address" value="<?php echo e(Illuminate\Support\Facades\Auth::user()->adminrelation->address); ?>" id="Form-pass5" class="form-control validate white-text">
