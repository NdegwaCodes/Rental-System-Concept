...
<section id="sidebar" > 
  ...
  <div id="sidebar-nav" style="background-color: black;"> 
    ...
    <ul>
      <li class="active"><a href="<?php echo e(route('admin_dashboard')); ?>"><i class="fa fa-dashboard"></i>Dashboard</a></li>
  ...
  <div class="row state-overview">
        <div class="col-lg-6 col-sm-6">
            <section class="panel">
                ...
                <div class="value">
                    <h3 class="count"><?php echo e(App\User::all()->where('role_id_fk','=',2)->count()); ?></h3>
                    <p>Total Tenant</p>
                </div>
            </section>
        </div>
        <div class="col-lg-6 col-sm-6">
            <section class="panel">
                ...
                <div class="value">
                    <h3 class="count"><?php echo e(App\User::all()->where('role_id_fk','=',3)->count()); ?></h3>
                    <p>Total Advisor</p>
                </div>
            </section>
        </div>
        <div class="col-lg-6 col-sm-6">
            <section class="panel">
                ...
                <div class="value">
                    <h3 class=" count2"><?php echo e(App\AdvisorPost::all()->count()); ?></h3>
                    <p>Total Post</p>
                </div>
            </section>
        </div>
