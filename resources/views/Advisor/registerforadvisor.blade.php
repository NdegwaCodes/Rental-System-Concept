...
@if ($errors->any())
  ...
  <fieldset>
    ...
    <input type="text" name="cnic" placeholder="CNIC" require/>
    <input type="text" name="brand" placeholder="Property Brand Name" require/>
    <input type="text" name="ntn" placeholder="NTN Number" require/>
