...
<section id="sidebar"> 
  ...
  <div id="sidebar-nav" style="background-color: black;"> 
    ...
    <ul>
      ...
      <li class="active"><a href="{{route('advisor_profile')}}"><i class="fa fa-user"></i> Profile</a></li>
...
<section id="content">
  ...
  <div class="content">
    ...
    <div id="sortable">
        <h5>First Name: </h5><span>{{Illuminate\Support\Facades\Auth::user()->advisorrelation->first_name}}</span>
        <h5>Last Name: </h5><span>{{Illuminate\Support\Facades\Auth::user()->advisorrelation->last_name}}</span>
        <h5>NTN Number: </h5><span>{{Illuminate\Support\Facades\Auth::user()->advisorrelation->ntn}}</span>
        <h5>CNIC: </h5><span>{{Illuminate\Support\Facades\Auth::user()->advisorrelation->cnic}}</span>
        <h5>Brand Name: </h5><span>{{Illuminate\Support\Facades\Auth::user()->advisorrelation->brand}}</span>
        <h5>Phone:  </h5><span>{{Illuminate\Support\Facades\Auth::user()->advisorrelation->phone}}</span>
        <h5>Address: </h5><span>{{Illuminate\Support\Facades\Auth::user()->advisorrelation->address}}</span>
    ...
    <div class="modal-content card card-image" style="background-image: url('img/login.jpg');">
      <div class="text-white rgba-stylish-strong py-5 px-5 z-depth-4">
        ...
        <div class="modal-body">
          <!--Body-->
		  <form action="{{route('advisor_update_profile.update',[Illuminate\Support\Facades\Auth::user()->id])}}" method="post" autocomplete="off">
		  @csrf
      @method('put')
          <div class="md-form mb-5">
            <input type="text" name="fname" value="{{Illuminate\Support\Facades\Auth::user()->advisorrelation->first_name}}" id="Form-email5" class="form-control validate white-text">
            <label data-error="wrong" data-success="right" for="Form-email5">First Name</label>
          </div>
          <div class="md-form pb-3">
            <input type="text" name="lname" value="{{Illuminate\Support\Facades\Auth::user()->advisorrelation->last_name}}" id="Form-pass5" class="form-control validate white-text">
            <label data-error="wrong" data-success="right" for="Form-pass5">LastName</label>
          </div>
          <div class="md-form pb-3">
            <input type="text" name="ntn" value="{{Illuminate\Support\Facades\Auth::user()->advisorrelation->ntn}}" id="Form-pass5" class="form-control validate white-text">
            <label data-error="wrong" data-success="right" for="Form-pass5">NTN Number</label>
          </div>
          <div class="md-form pb-3">
            <input type="text" name="cnic" value="{{Illuminate\Support\Facades\Auth::user()->advisorrelation->cnic}}"  id="Form-pass5" class="form-control validate white-text">
            <label data-error="wrong" data-success="right" for="Form-pass5">CNIC</label>
          </div>
          <div class="md-form pb-3">
            <input type="text" name="brand" value="{{Illuminate\Support\Facades\Auth::user()->advisorrelation->brand}}" id="Form-pass5" class="form-control validate white-text">
            <label data-error="wrong" data-success="right" for="Form-pass5">Brand Name</label>
          </div>
          <div class="md-form pb-3">
            <input type="text" name="phone" value="{{Illuminate\Support\Facades\Auth::user()->advisorrelation->phone}}" id="Form-pass5" class="form-control validate white-text">
            <label data-error="wrong" data-success="right" for="Form-pass5">Phone Number</label>
          </div>
          <div class="md-form pb-3">
            <input type="text" name="address" value="{{Illuminate\Support\Facades\Auth::user()->advisorrelation->address}}" id="Form-pass5" class="form-control validate white-text">
